...
extern volatile int TIM11_ds1302_1ms_counter;  // ADD_PSJ_0930  // ADD_PSJ_0930
...
void ds1302_flash_clock(void)
{
	...
	ds1302_read_date();
	// 3. printf time, date
	if (TIM11_ds1302_1ms_counter >= 1)
	{
		TIM11_ds1302_1ms_counter = 0;
...
//
//	if (TIM11_ds1302_1ms_counter >= 10000)
//	{
//		TIM11_ds1302_1ms_counter = 0;
//		//flash_erase();
